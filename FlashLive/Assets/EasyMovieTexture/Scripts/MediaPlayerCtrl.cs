...
public class MediaPlayerCtrl : MonoBehaviour {
    ...
    public AudioSource audios, audios2;
    ...
    void GET()
    {
        ...
        str = Regex.Replace(CloudRecoTrackableEventHandler.names2, @".jpg", "");
    
        if (str.Contains("mp4"))
        {
            raw.SetActive(true);
            Stop();
            Load(Example2_WWW.objFileName2video);
            uAudio.uAudioStreamer_UI.pause = true;
            Play();
            CloudRecoTrackableEventHandler.on4 = false;
            ...
            if (str.Contains("html"))
            {
             ...
             raw.SetActive(false);
             Application.OpenURL("http://37.187.147.129/projet/flashlive/rest.php?html=" + str);
            ...
            uAudio.uAudioStreamer_UI.url = Example2_WWW.objFileName5video;
            uAudio.uAudioStreamer_UI.start = true;
            audios.Play();
            raw.SetActive(false);
            CloudRecoTrackableEventHandler.on4 = false;
        }
    ...
    void Update()
	{
        ...
        if (CloudRecoTrackableEventHandler.on4==true)
        {
        ...
        if (CloudRecoTrackableEventHandler.stop == true)
        {
